...
class CursoRepositoryTest extends TestCase
{
    ...
    public function testReadCurso()
    {
        ...
        $dbCurso = $this->cursoRepo->find($curso->idcurso);
    ...
    public function testUpdateCurso()
    {
        ...
        $updatedCurso = $this->cursoRepo->update($fakeCurso, $curso->idcurso);
    ...
    {
        $curso = $this->makeCurso();
        $resp = $this->cursoRepo->delete($curso->idcurso);
        $this->assertTrue($resp);
        $this->assertNull(Curso::find($curso->idcurso), 'Curso should not exist in DB');
    }
}
